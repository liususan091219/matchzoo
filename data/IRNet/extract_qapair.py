...
if __name__ == '__main__':
    ...
    question_int = answer_int = 0

    question_int, answer_int = extract_pair(sql_data, "train", fout2, db2colstr2tablist, question_int, answer_int)
    extract_pair(val_sql_data, "dev", fout2, db2colstr2tablist, question_int, answer_int)
